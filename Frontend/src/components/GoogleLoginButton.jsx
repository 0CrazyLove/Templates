 ...
 * 
 * Handles the Google OAuth flow using the useGoogleLogin hook.
 * This component must be wrapped in a GoogleOAuthProvider.
 * 
 * @param {Object} props
 * @param {Function} props.onSuccess - Callback for successful login
 * @param {Function} props.onError - Callback for failed login
 * @param {boolean} props.loading - Loading state
 */
export default function GoogleLoginButton({ onSuccess, onError, loading }) {
